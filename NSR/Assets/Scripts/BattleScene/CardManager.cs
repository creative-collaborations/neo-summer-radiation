...
public class CardManager : MonoBehaviour
{
    ...
    public List<Card> initializeDeck(){
        ...
        for (int i=0; i< 10; i++){
            cards.Add(new GreenPunchCard());
            cards.Add(new YellowPunchCard());
            cards.Add(new RedPunchCard());
            cards.Add(new GreenKickCard());
            cards.Add(new YellowKickCard());
            cards.Add(new RedKickCard());
